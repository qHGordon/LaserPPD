...
public class Game06_GameUIComm : MonoBehaviour
{
    ...
    public static Game06_GameUIComm instance;
    ...
    void Update()
    {
        ...
        if (Game06_Main.instance.statue<en_Game00_Sta.Ready)
        {
    ...
    {
        Game06_Main.instance.continueResult = 1;
    }
    public void OnClick_ContinueNo()
    {
        Game06_Main.instance.continueResult = 2;
    }
