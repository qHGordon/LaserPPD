...
public class LedAnim_Struts_07 : MonoBehaviour
{
    ...
    public void Init(bool _isLeft, Game_Map07 _ledAnim)
    {
        isTank = false;
        ledAnim = _ledAnim;
    ...
    public void Init_Game06_V()
    {
        ...
        for (int i = 0; i < Game_Map07.instance.targetPos.Length; i++)
        {
            Game_Map07.instance.targetPos[i].Set(-1, -1);
        }
        ...
        for (int i = Set.setVal.Width / 4; i < Set.setVal.Width / 2; i++)
        {
            ...
            {
                Game_Map07.instance.targetPos[snakeCnt].Set(i, cntY);
                snakeCnt++;
                x++;
                cntX++;
                cntY--;
        ...
        for (int i = 0; i < Game_Map07.instance.Pos_DianZu.Length; i++)
        {
            float pos = 0;
            ...
            if (i == 0)
            {
                ...
                picID = (int)Game_Map07.instance.targetPos[snakeCnt - 1].x + (int)Game_Map07.instance.targetPos[snakeCnt - 1].y * Set.setVal.Width;
                pointID = Framebuffer.tab_Mapping[picID];

                Game_Map07.instance.Pos_DianZu[Game_Map07.instance.Cnt_DianZu] = pointID;


                Game_Map07.instance.Cnt_DianZu++;
            }
            else
            {
                ...
                picID = (int)Game_Map07.instance.targetPos[(int)pos].x + (int)Game_Map07.instance.targetPos[(int)pos].y * Set.setVal.Width;
                pointID = Framebuffer.tab_Mapping[picID];
        ...
        Game_Map07.instance.Cnt_DianLiu = snakeCnt;
    ...
    public void Init_Game06_WenHao()
    {
        ...
        for (int i = Set.setVal.Height * 3 / 4; i < Set.setVal.Height - 1; i++)
        {
            ...
            Game_Map07.instance.targetPos[snakeCnt].Set(Set.setVal.Width / 4, i);
            snakeCnt++;
        ...
        for (int i = Set.setVal.Width / 4; i < Set.setVal.Width * 3 / 4; i++)
        {
            ...
            Game_Map07.instance.targetPos[snakeCnt].Set(i, Set.setVal.Height - 2);
            snakeCnt++;
        ...
        for (int i = Set.setVal.Height - 2; i > Set.setVal.Height / 2; i--)
        {
            ...
            Game_Map07.instance.targetPos[snakeCnt].Set(Set.setVal.Width * 3 / 4, i);
            snakeCnt++;
        ...
        for (int i = Set.setVal.Height / 2; i > 3; i--)
        {
            ...
            Game_Map07.instance.targetPos[snakeCnt].Set(Set.setVal.Width / 2, i);
            snakeCnt++;


        }

        Game_Map07.instance.targetPos[snakeCnt].Set(Set.setVal.Width / 2, 2);
        snakeCnt++;
    ...
    public void Init_Game06_L()
    {
        ...
        for (int i = Set.setVal.Height - 2; i > 1; i--)
        {
            ...
            Game_Map07.instance.targetPos[snakeCnt].Set(Set.setVal.Width / 4 - 1, i);
            snakeCnt++;
        ...
        for (int i = Set.setVal.Width / 4; i < Set.setVal.Width * 3 / 4 + 1; i++)
        {
            ...
            Game_Map07.instance.targetPos[snakeCnt].Set(i, 2);
            snakeCnt++;
        ...
        for (int i = Set.setVal.Width * 3 / 4; i > Set.setVal.Width / 4; i--)
        {
            ...
            Game_Map07.instance.targetPos[snakeCnt].Set(i, 3);
            snakeCnt++;
    ...
    {
        picType = (PicType)ID;
        int col = Random.Range(0, Game_Map07.instance.tab_PointColor.Length);
        for (int i = Set.setVal.Width / 2 - 1; i < Set.setVal.Width / 2 + 2; i++)
        {
            for (int k = Set.setVal.Height / 2 - 1; k < Set.setVal.Height / 2 + 2; k++)
            {
                ...
                pointID = Framebuffer.tab_Mapping[picID];
                GameLedControl.gamePoint[pointID].statue = enPointSta.Target;
                Game_Map07.instance.Led_Color[pointID] = Game_Map07.instance.tab_PointColor[col];
            }
        }
    ...
    public void GetTatagePos()
    {
        ...
        while (tarageNum > 0 && cnt > 0)
        {
            ...
            if (GameLedControl.gamePoint[x].statue == enPointSta.None)
            {
                ...
                cnt = Random.Range(0, Game_Map07.instance.tab_PointColor.Length);
                Game_Map07.instance.Led_Color[x] = Game_Map07.instance.tab_PointColor[cnt];
            }
        }

    }
    int[] TarageNum_List;
    public void GetTarage(int ch)
    {
        ...
        if (tarageNum > 0)
        {
            while (tarageNum > 0)//
            {
                ...
                if (GameLedControl.gamePoint[pointID].statue == enPointSta.None && Game_Map07.instance.Led_Color[pointID] == 0)
                {
                    if (ID == 0)
                    {
                        GameLedControl.gamePoint[pointID].statue = enPointSta.Target;
                    ...
                    else
                    {
                        GameLedControl.gamePoint[pointID].statue = enPointSta.Target;
                        tarageNum--;
                        Game_Map07.instance.Led_Color[pointID] = 0x00ff00;
                    }
            ...
            while (tarageNum > 0)//
            {
                ...
                if (GameLedControl.gamePoint[pointID].statue == enPointSta.None && Game_Map07.instance.Led_Color[pointID] == 0)
                {
                    ...
                    else
                    {
                        GameLedControl.gamePoint[pointID].statue = enPointSta.Die;
                        tarageNum--;
                        Game_Map07.instance.Led_Color[pointID] = 0xff0000;
                    }
