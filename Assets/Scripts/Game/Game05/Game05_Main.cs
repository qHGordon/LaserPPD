...
public class Game05_Main : MonoBehaviour
{
    public Game05_GameUIComm gameUIComm;
    public Game05_GameUI gameUI_Single;
    public Game05_GameUI gameUI_MulitPlayer;
    Game05_GameUI gameUI;
    public GameObject shakeMain_Obj;
    public Game05_Player[] player;
    ...
    public static Game05_Main instance;
    ...
    void Update()
    {
        ...
        switch (statue)
        {
            ...
            case en_Game00_Sta.Play:
                ...
                //
                if (remainTime > 0 && Game_Map05.instance.isMoving == false)
                {
                ...
                //
                if (Index_JieDuan >= Game_Map05.instance.MaxJieDuan)// 
                {
                    ChangeStatue(en_Game00_Sta.ShowResult);
                ...
                if (Game_Map05.instance.isClearAll)
                {
                    if (Main.IsDemo)
                    {
                        ChangeStatue(en_Game00_Sta.Out);
                    ...
                    else
                    {
                        ...
                        Game_Map05.instance.isCleaning = true;

                        runTime += Time.deltaTime;
                        if (Game_Map05.instance.Run_MapClear() || runTime > 3f)
                        {
                ...
                {
                    if (Game_Map05.instance.remainPoint <= 0)
                    {
                        if (Main.IsDemo)
                        {
                            ChangeStatue(en_Game00_Sta.Out);
                        ...
                        else
                        {
                            ...
                            if (Game_Map05.instance.Run_MapClear())
                            {
            ...
            case en_Game00_Sta.ShowResult:
                ...
                if (runTime >= 2)
                {
                    ...
                    {
                        // if (LedKey.KeyPressed(Game05_Main.instance.targetKeyId) || Input.GetKeyDown(KeyCode.Q))
                        {
                            Main.MapIndex++;
                            if (Main.MapIndex >= 30)
                            {
    ...
    public void ChangeStatue(en_Game00_Sta sta)
    {
        ...
        switch (statue)
        {
            ...
            case en_Game00_Sta.Play:
                ...
                Game_Map05.instance.InitMap(gameLevel);
                break;
...
#endif
    public List<Image> list_PresetPic = new List<Image>();
    void PresetPic_Init()
    {
    ...
    public void NextJieDuan()
    {
        ...
        remainTime = maxremainTime = SettingInGame_02.instance.set_LevelTime;
        Game_Map05.instance.isClearAll = false;//是否清理了所有的点
