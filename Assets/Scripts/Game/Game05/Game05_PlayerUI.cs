...
public class Game05_PlayerUI : MonoBehaviour
{
    ...
    {
        scores =Game05_Main.instance.Score_LinShi;
    ...
    public void Update_RemainPoint()
    {
            ...
            if (Game05_Main.instance.isClearTarage)
            {
        ...
        remainPoint = Game_Map05.instance.remainPoint;
