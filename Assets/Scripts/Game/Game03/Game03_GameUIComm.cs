...
public class Game03_GameUIComm : MonoBehaviour
{
    ...
    public static Game03_GameUIComm instance;
    ...
    {
        Game03_Main.instance.continueResult = 1;
    }
    public void OnClick_ContinueNo()
    {
        Game03_Main.instance.continueResult = 2;
    }
