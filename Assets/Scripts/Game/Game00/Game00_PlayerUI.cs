...
public class Game00_PlayerUI : MonoBehaviour
{
    ...
    public SettingInGame_01 Ingame_Setting;
    ...
    public void Awake0(int no)
    {
        ...
        //    for (int i = 0; i < len; i++) {
        //        lifeOne[i] = Instantiate (Game00_Main.instance.lifeOne_Prefab, life_Layer).GetComponent<Game00_LifeOne> ();
    ...
    public void GameStart(int fulllife, int playernum)
    {
        ...
        //Life_Init (playernum);
        Update_Life();
        text_Scores.transform.parent.gameObject.SetActive(false);
        Update_Scores();
        Update_RemainPoint();
        //
    ...
    void Update()
    {
        ...
        if (scores !=Game00_Main.instance.Score_LinShi)
        {
            Update_Scores();
        }
    ...
    {
        scores = Game00_Main.instance.Score_LinShi;// FjData.g_Fj[playerId].Scores;
    ...
    public void Update_RemainPoint()
    {
        ...
        {
            if (!remainPoint_Obj.gameObject.activeSelf && Game00_Main.instance.gameLevel != 25)
            {
                remainPoint_Obj.gameObject.SetActive(true);
            }
        }
        remainPoint = Game_Map00.instance.remainPoint;
    ...
    {
        if (remainPoint_Obj != null && playerNum >= 2)
        {
        ...
        if (pass != 0)
        {
            ...
            if (Main.PlayTime <= 0)
            {
                image_Result.sprite = sprite_Result[2];
