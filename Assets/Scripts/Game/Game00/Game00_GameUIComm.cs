...
public class Game00_GameUIComm : MonoBehaviour {
    ...
    public static Game00_GameUIComm instance;
	...
	public void Update_JieDuan (int level) {
        ...
        Game00_GameUIComm.instance.image_JieDuan.SetNativeSize();
    }
    ...
    //    image_ReadyTime.transform.localScale = Vector3.one * 3;
    }
	...
	public void OnClick_ContinueYes () {
        Game00_Main.instance.continueResult = 1;
    }
	public void OnClick_ContinueNo () {
        Game00_Main.instance.continueResult = 2;
    }
