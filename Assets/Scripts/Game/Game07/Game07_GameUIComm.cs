...
public class Game07_GameUIComm : MonoBehaviour
{
    ...
    public static Game07_GameUIComm instance;
    float buttonExitShowTime;

    public GameObject Img_Introduce;
    public Sprite[] Spr_Ruless;
    public Image  Spr_Rule;
    void Awake()
    {
    ...
    public void GameStart()
    {
        ...
        Img_Introduce.gameObject.SetActive(true);
        //Spr_Rule.sprite = Spr_Ruless[Main.MapIndex];
        //Spr_Rule.SetNativeSize();
    }

    void Update()
    {

        if (Game07_Main.instance.statue<en_Game00_Sta.Ready)
        {
            if (!Img_Introduce.gameObject.activeSelf)
            {
                Img_Introduce.gameObject.SetActive(true);
            }
        }
        else
        {
            if (Img_Introduce.gameObject.activeSelf)
            {
                Img_Introduce.gameObject.SetActive(false);
            }
        }
    ...
    {
        Game07_Main.instance.continueResult = 1;
    }
    public void OnClick_ContinueNo()
    {
        Game07_Main.instance.continueResult = 2;
    }
