...
public class Game04_GameUIComm : MonoBehaviour
{
    ...
    public static Game04_GameUIComm instance;
    ...
    {
        Game04_Main.instance.continueResult = 1;
    }
    public void OnClick_ContinueNo()
    {
        Game04_Main.instance.continueResult = 2;
    }
