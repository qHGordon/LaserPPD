...
public class Game04_Player : MonoBehaviour
{
    //#if UNITY_EDITOR
    ...
    public Game04_PlayerUI playerUI;

    public Game04_Main gameMain;
    public int Id;
    public int result;
    ...
    public void Awake0(Game04_Main gmain, int no)
    {
        gameMain = gmain;
        Id = no;
    ...
    public void OnClick_Set()
    {
        ...
        SettingInGame_02.instance.GGstart();
    }
    public void Ready()
    {
        if (playerUI != null)
        {
            playerUI.GameStart(FjData.g_Fj[0].Life);
        }
