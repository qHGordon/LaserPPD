...
public class Game23_Block
{
	...
	public Game23_Block(Vector2Int dir_vec, BlockType block_ty, Func<Vector2Int> get_max_pos)
	{
		DirVec = dir_vec;
		BlockTy = block_ty;
...
/// 派生地砖城堡，由多个地砖的位置组成
/// </summary>
public class Game23_Castle : Game23_Block
{
	...
	public Game23_Castle(bool is_dir_x, bool is_dir_y, Vector2Int dir_vec, BlockType block_ty, List<Vector2Int> hp_list, Func<Vector2Int> get_max_pos) : base(dir_vec, block_ty, get_max_pos)
	{
		IsDirX = is_dir_x;
		IsDirY = is_dir_y;
		HpList = hp_list;
...
/// 派生地砖子弹，由一个地砖组成
/// </summary>
public class Game23_Bullet : Game23_Block
{

	public static Dictionary<Vector2Int, Game23_Bullet> BulletDic = new Dictionary<Vector2Int, Game23_Bullet>();
	...
	public Game23_Bullet(Vector2Int dir_vec, Vector2Int pos, BlockType block_ty, Func<Vector2Int> get_max_pos) : base(dir_vec, block_ty, get_max_pos)
	{
		Pos = pos;
		BulletDic[Pos] = this;
	}
