...
public class SettingInGame_03 : SettingInGame
{
    ...
    {
        int a = PlayerPrefs.GetInt("set_BlueNum");
        if (a == 0)
        {
            a = set_BlueNum;
        }
    ...
    {
        int a = PlayerPrefs.GetInt("set_LifeNum");
        if (a == 0)
        {
            a = set_LifeNum;
        }
    ...
    {
        int a = PlayerPrefs.GetInt("set_LevelTime");
        if (a == 0)
        {
            a = set_LevelTime;
        }
    ...
    {
        int a = PlayerPrefs.GetInt("set_MoveSpeed" + i.ToString());
        if (a == 0)
        {
            a = set_MoveSpeed[i];
        }
    ...
    {
        int a = PlayerPrefs.GetInt("set_TarageNum" + i.ToString());
        if (a == 0)
        {
            a = set_TarageNum[i];
        }
    ...
    public static SettingInGame_03 instance;
    private void Awake()
    {
        instance = this;
        SetInit(13);
    ...
    {
        PlayerPrefs.SetInt("set_BlueNum", set_BlueNum);
        PlayerPrefs.SetInt("set_LevelTime", set_LevelTime);
        PlayerPrefs.SetInt("set_LifeNum", set_LifeNum);
        for (int i = 0; i < 5; i++)
        {
            PlayerPrefs.SetInt("set_MoveSpeed" + i.ToString(), set_MoveSpeed[i]);
            PlayerPrefs.SetInt("set_TarageNum" + i.ToString(), set_TarageNum[i]);
        }
