...
public class Game02_GameUIComm : MonoBehaviour
{
    ...
    public static Game02_GameUIComm instance;
    ...
    {
        Game02_Main.instance.continueResult = 1;
    }
    public void OnClick_ContinueNo()
    {
        Game02_Main.instance.continueResult = 2;
    }
