...
public class Game02_Main : MonoBehaviour
{
    ...
    public Game02_GameUI gameUI_MulitPlayer;
    Game02_GameUI gameUI;
    public GameObject shakeMain_Obj;
    public Game02_Player[] player;
    ...
    public static Game02_Main instance;
    ...
    public void GameStart()
    {
        ...
        Debug.LogError(Game02_Main.instance.gameLevel + "    " + Game02_Main.instance.BigGameLevel);
        IO.WallLED_All(0);
    ...
    void Update()
    {
        ...
        switch (statue)
        {
            ...
            case en_Game00_Sta.Play:
                ...
                //
                if (Index_JieDuan >= 3)// Game_Map02.instance.MaxJieDuan
                {
                    ChangeStatue(en_Game00_Sta.ShowResult);
                ...
                if (Game_Map02.instance.isClearAll)
                {
                    if (Main.IsDemo)
                    {
                        ChangeStatue(en_Game00_Sta.Out);
                    ...
                    else
                    {
                        ...
                        Game_Map02.instance.isCleaning = true;


                        if (Game_Map02.instance.Run_MapClear())
                        {
                ...
                {
                    if (Game_Map02.instance.remainPoint <= 0)
                    {
                        if (Main.IsDemo)
                        {
                            ChangeStatue(en_Game00_Sta.Out);
            ...
            case en_Game00_Sta.ShowResult:
                ...
                if (runTime >= 2)
                {
                    ...
                    {
                        if (LedKey.KeyPressed(Game02_Main.instance.targetKeyId) || Input.GetKeyDown(KeyCode.Q))
                        {
                ...
                switch (Framebuffer.led[pointId].statue)
                {
                    ...
                    case enPointSta.Target:
                        if (BigGameLevel==3)
                        {
                            if (y>2)
                            {
                                Framebuffer.led[pointId].statue = enPointSta.None;
            ...
            if (Framebuffer.led[pointId].statue == enPointSta.Target)
            {
                    ...
                    for (int j = 0; j < 1; j++)
                    {
                        if (HitTargetPoint(j, x, y))
                        {
                            ...
                            if (BigGameLevel > 0)
                            {
                                for (int i = 0; i < Game_Map02.instance.tarage_Pos.Length; i++)
                                {
                                    if (x == Game_Map02.instance.tarage_Pos[i].x && y == Game_Map02.instance.tarage_Pos[i].y)
                                    {
                                        Game_Map02.instance.tarage_Pos[i] = Vector2.one * -1;
                                    }
                                }
                            }
                            //if (gameLevel == 20)
                            ...
                            //    {
                            //        Game_Map02.instance.remainPoint--;
                            //    }

                            //}
                            //  Game_Map02.instance.SafeTime = 10;
    ...
    public void NextJieDuan()
    {
        ...
        remainTime = maxremainTime = SettingInGame_02.instance.set_LevelTime;
        Game_Map02.instance.isClearAll = false;//是否清理了所有的点
