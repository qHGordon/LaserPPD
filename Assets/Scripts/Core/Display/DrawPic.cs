...
public class DrawPic
{
    ...
    public static void DrawPointIdByCh(int ch, int id, uint color, enPointSta statue)
    {
        if (id >= Framebuffer.led.Length)
            return;
        if (Framebuffer.led[id].statue == enPointSta.Rest)
    ...
    public static void DrawCirculation(int x, int y, int ridio, uint color, enPointSta statue)
    {
