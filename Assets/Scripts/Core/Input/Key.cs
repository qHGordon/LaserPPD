...
public class Key {
    ...
    const int KEY_GROUP = AppConst.MAX_WALLLED;
    ...
    // 屏幕微调坐标(UI局部坐标) 
    public static int[] cursorPos_Left = new int[AppConst.MAX_PLAYER];
    public static int[] cursorPos_Right = new int[AppConst.MAX_PLAYER];
    public static int[] cursorPos_Up = new int[AppConst.MAX_PLAYER];
    public static int[] cursorPos_Down = new int[AppConst.MAX_PLAYER];
    //
    public static int[] screen_Width = new int[AppConst.MAX_PLAYER];
    public static int[] screen_Height = new int[AppConst.MAX_PLAYER];
    // 上下[0]; 左右:[1]
    //static int[] adMaxValue = new int[AppConst.MAX_PLAYER * 2];
    //static int[] adMinValue = new int[AppConst.MAX_PLAYER * 2];
    public static int[] adcMinXValue = new int[AppConst.MAX_PLAYER];
    public static int[] adcMidXValue = new int[AppConst.MAX_PLAYER];
    public static int[] adcMaxXValue = new int[AppConst.MAX_PLAYER];
    static int[] adcMinYValue = new int[AppConst.MAX_PLAYER];
    static int[] adcMidYValue = new int[AppConst.MAX_PLAYER];
    static int[] adcMaxYValue = new int[AppConst.MAX_PLAYER];
    public static int[] adValue = new int[AppConst.MAX_PLAYER * 2];

    static int[,] adBuf = new int[AppConst.MAX_PLAYER * 2, 10];
    static int[] adBufIn = new int[AppConst.MAX_PLAYER * 2];
